...
bool PSystem::BoundingBox::isPointInside(D3DXVECTOR3& p)
{
...
bool PSystem::init(IDirect3DDevice9* device, char* texFileName)
{
	...
	hr = D3DXCreateTextureFromFile(
		device,
		convertCharArrayToLPCWSTR(texFileName),
		&_tex);
...
Snow::Snow(PSystem::BoundingBox* boundingBox, int numParticles)
{
...
wchar_t* PSystem::convertCharArrayToLPCWSTR(const char* charArray)
{
